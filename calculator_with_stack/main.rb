...
loop do
    if number1.nil?
      ...
      print("Бажаєте використати попередній результат для наступних операцій? (1 - Так / 2 - Ні): ")
      choice = gets.chomp.downcase
      unless choice == "1" || choice == "так"
        number1 = $stack.empty? ? 0 : $stack.last
        break if choice == "2" || choice == "ні"
        next
      end
      number1 = pop_from_stack unless $stack.empty?
      next if number1.nil?
    end
  if number1
    if number1.integer?
